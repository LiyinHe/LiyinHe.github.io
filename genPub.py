# # first generate liyin_doi.bob
# python3 searchdoi.py liyin.bib

from collections import defaultdict
with open("/Users/lhe/Library/CloudStorage/OneDrive-Personal/Github/LiyinHe.github.io/people/publications/liyin_doi.bib") as f:
    file = f.read()
...
def parse_entry(entry,write=True):
    ...
    # write to file
    if write:
        with open(f"/Users/lhe/Library/CloudStorage/OneDrive-Personal/Github/LiyinHe.github.io/people/publications/{file_name}.qmd", "w") as f:
            f.write("---\n")
...
with open('/Users/lhe/Library/CloudStorage/OneDrive-Personal/Github/LiyinHe.github.io/people/publications/liyin_doi.bib') as bibtex_file:
...
with open('/Users/lhe/Library/CloudStorage/OneDrive-Personal/Github/LiyinHe.github.io/people/publications/liyin_doi.bib', 'w') as bibtex_file:
